...
namespace BlockchainAssignment
{
    public partial class BlockchainApp : Form
    {
        ...
        private void NewBlock_Click(object sender, EventArgs e)
        {
            ...
            String typeTransactions = "";

            if (radioButtonGreedy.Checked == true) {
                typeTransactions = "greedy";
            }
            else if (radioButtonRandom.Checked == true)
            {
                typeTransactions = "random";
            }
            else
            {
                typeTransactions = "longWait";
            }
            ...
            Block newBlock = new Block(blockchain.GetLastBlock(), transactions, publicKey.Text, typeTransactions);
